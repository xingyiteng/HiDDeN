...
if __name__ == "__main__":
    ...
    # 配置文件路径
    options_file = 'D:\workspace\watermark\HiDDeN\mdfa\combined\options-and-config.pickle'
    checkpoint_file = 'D:\workspace\watermark\HiDDeN\mdfa\combined\mdfa_combined-noise_32--epoch-400.pyt'
